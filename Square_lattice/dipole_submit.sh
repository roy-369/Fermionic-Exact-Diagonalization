...
time
#source ~/.bashrc
python /home/roy.369/Research/Mott_Insulators/2_dimension/Square_lattice/Post_March_Meeting/FHM_2d_dipole_current_OBC_cluster.py $Nx $Ny $U $t1 2000 &> dipole_output.out
time
EOF
)"	
         		echo "$rawjob" &> job.bat
