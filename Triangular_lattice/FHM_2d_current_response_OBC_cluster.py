...
def linear_currents(Nx,Ny,Np,U,t1,N,Raw_nos,Lambda_matrix_1x,Lambda_matrix_1y,energies, omega,eta,zeta):
    ...
    sigma_xx_para = np.zeros(len(omega),dtype = np.complex64)
    sigma_xy_para = np.zeros(len(omega),dtype = np.complex64)
    sigma_yx_para = np.zeros(len(omega),dtype = np.complex64)
    sigma_yy_para = np.zeros(len(omega),dtype = np.complex64)
    sigma_xx_dia = np.zeros(len(omega),dtype = np.complex64)
    sigma_xy_dia = np.zeros(len(omega),dtype = np.complex64)
    sigma_yx_dia = np.zeros(len(omega),dtype = np.complex64)
    sigma_yy_dia = np.zeros(len(omega),dtype = np.complex64)
...
def nonlinear_current_lp(Np,N,U,Raw_nos,Lambda_matrix_1x,Lambda_matrix_1y,dipole_moment_x,dipole_moment_y,energies,omega,eta):
    ...
    chi_x_xx_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_x_xy_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_x_yx_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_x_yy_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_y_xx_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_y_xy_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_y_yx_lp = np.zeros(len(omega),dtype = np.complex64)
    chi_y_yy_lp = np.zeros(len(omega),dtype = np.complex64)
    for i in range(len(omega)):
        for n in range(len(energies)):
            if(n == 0):
                  f_n = 1
...
def nl_currents_SHG(Np,N,U,Raw_nos,energies,Lambda_matrix_1x,Lambda_matrix_1y,dipole_moment_x,dipole_moment_y,omega,eta):
    ...
    chi_x_xx_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_x_xy_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_x_yx_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_x_yy_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_y_xx_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_y_xy_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_y_yx_SHG = np.zeros(len(omega),dtype = np.complex64)
    chi_y_yy_SHG = np.zeros(len(omega),dtype = np.complex64)
