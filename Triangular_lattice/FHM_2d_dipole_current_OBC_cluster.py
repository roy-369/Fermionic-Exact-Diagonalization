...
def dipole_op_con(t,t1,a,rx,ry,U,basis,Nx,Ny,N,Np,Raw_nos,data_dir):
    ...
    dipole_x_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
    dipole_y_mat = np.zeros((len(en),len(en)),dtype = np.complex64) 
    lambda_x_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
    lambda_y_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
    ...
    lambda_xx_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
    lambda_xy_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
    lambda_yx_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
    lambda_yy_mat = np.zeros((len(en),len(en)),dtype = np.complex64)
