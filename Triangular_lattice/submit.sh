...
time
#source ~/.bashrc
python /home/roy.369/Research/Mott_Insulators/2_dimension/Triangular_lattice/FHM_2d_spectrum_OBC_cluster.py $Nx $Ny $U $t1 2000 &> output.out
